...
namespace SignalRApi.Controllers
{
    ...
    public class FeatureController : ControllerBase
    {
        ...
        public IActionResult FeatureCreate(CreateFeatureDto createFeatureDto)
        {
            ...
            return Ok("Öne Çıkan Alan Bilgisi Başarılı Bir Şekilde Eklendi");
        }
        ...
        public IActionResult FeatureDelete(int id)
        {
            ...
            return Ok("Öne Çıkan Alan Bilgisi Başarılı Bir Şekilde Silindi");
        }
        ...
        public IActionResult FeatureUpdate(UpdateFeatureDto updateFeatureDto)
        {
            ...
            return Ok("Öne Çıkan Alan Bilgisi Başarılı Bir Şekilde Güncellendi");
        }
